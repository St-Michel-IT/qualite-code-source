...
update_the_balance()
    ...
    \begin{frame}[fragile]
        ...
        \begin{itemize}
            ...
            \item Toutes les documentations sont dans les docstring, une structure propre à Python. Les docstrings sont dans l'attribue \texttt{\_\_doc\_\_} qui peut être appelé dans le shell Python avec la fonction help
            \item Documente les déclarations \texttt{def} et \texttt{class}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Generate documentation from source code, c'est aussi générique que cela! \emoji{smiling-face-with-halo}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Node JS, dans \texttt{node\_modules} ou dans le répertoire en fonction de l'installation
    ...
    \begin{frame}
        \transdissolve
        \frametitle{Testing, les frameworks}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Créer un soft inexistant simple. Par exemple comme celui de la question :
            \begin{itemize}
                \item En Java
                \item En C++
            \end{itemize}
            \item Un projet open source déjà existant ne mettant pas en application les bonnes pratiques de ce cours. Raymond Hettinger a commencé par compléter des commentaires et la documentation de Python et conseille de faire de même pour être onboarder sur un projet OS
            \item Bien d'autres encore !
