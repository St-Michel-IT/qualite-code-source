...
...:     return x % 2 == 0 # Biennnn
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            Mais la syntaxe doit être familière pour les développeurs pour les développeurs et donc s'inspirer des langages de l'époque C et C++
...
update_the_balance()
    ...
    \begin{frame}[fragile]
        ...
        \begin{itemize}
            ...
            Voir \url{https://www.sphinx-doc.org/en/master/usage/restructuredtext/index.htmlpour la définition}
            ...
            \item Toutes les documentations sont dans les docstring, une structure propre à Python.
            Les docstrings sont dans l'attribue \lstinline{\_\_doc\_\_} qui peut être appelé dans le shell Python avec la fonction help
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            Par exemple comme celui de la question~:
            \begin{itemize}
                \item En Java
                \item En C++
            \end{itemize}
...
AssertionError: Le restant de la division est différent de 0
    ...
    \begin{frame}[fragile]
        ...
        \begin{itemize}
            ...
            Les autres méthodes ne sont pas exécutées sauf si les tests ne les appellent.
        \end{itemize}
