...
TOTAL                      9      0   100%
    ...
    \begin{frame}
        \frametitle{Git et les autres VCS}
        \framesubtitle{\textquote{Best Version Control Tools}\footnote{Best Version Control Tools, \url{https://umangsoftware.com/best-version-control-tools/}}}
        \transdissolve
        Bien d'autres VCS au workflows très différents existent et subsistent malgré la suprématie de Git.

        Certains sans possibilité de conflict~! \emoji{astonished-face}
        \bigbreak
        \centering
        \includegraphics[width=9cm]{image/best-vcs}
    \end{frame}
