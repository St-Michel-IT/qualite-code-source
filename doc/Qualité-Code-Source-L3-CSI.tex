...
TOTAL                      9      0   100%
    ...
    \begin{frame}
        ...
        \bigbreak
        \centering
        \includegraphics[width=7cm]{image/gitk}
    \end{frame}
...
$ git pull
        ...
        \begin{itemize}
            ...
            Pour cela il faut rajouter à la commande précédente l'option \lstinline{--no-ff}.
...
Changes to be committed:
    ...
    \begin{frame}
        ...
        Son périmètre est restreint pour éviter les conflits de fusion de codes review trop complexes lors de la pull request.
    \end{frame}

    \begin{frame}[fragile]
        \frametitle{Git, les actions et leurs commandes}
        \framesubtitle{Patchning avec \lstinline{git rease}\footnote{Git Commands - Patching, \url{https://git-scm.com/book/en/v2/Appendix-C:-Git-Commands-Patching}}}
        \transdissolve
