        ...
        \begin{small}
            \begin{columns}
                ...
                \begin{itemize}
                    ...
                    \item Mettre en pratique tous les concepts vus dans ce cours
                    \item Par groupe de 3 maximum
                    \item Publier les résultats dans un repository sur une plateforme comme Github, Gitlab
                ...
                \column{0.4\textwidth}
                \centering
                \includegraphics[width=3.5cm]{image/working-together}
            \end{columns}
...
...
    ...
    \begin{frame}{Le business du CI/CD}{Ce n'est pas une simple technologie mais un marché, attention aux coûts}
        \transdissolve
        Git, Python, que nous avons vu, sont des technologies open source devenues des standards.
