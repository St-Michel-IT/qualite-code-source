...
TOTAL                      9      0   100%
    ...
    \begin{frame}[fragile]
        ...
        \framesubtitle{Etape 1, récupérer les sources et l'historique d'un repository existant\footnote{Git Basics - Getting a Git Repository, \url{https://git-scm.com/book/en/v2/Git-Basics-Getting-a-Git-Repository}}}
        \transdissolve
...
$ git clone <URL>
    ...
    \begin{frame}[fragile]
        \frametitle{Git, les actions et leurs commandes}
        \framesubtitle{Etape 1, si le repo n'existe pas, qu'on le créé\footnote{Git Basics - Getting a Git Repository, \url{https://git-scm.com/book/en/v2/Git-Basics-Getting-a-Git-Repository}}\footnote{Git remote, \url{https://git-scm.com/docs/git-remote}}}
        \transdissolve
...
$ git remote add -f -t master -m master origin <URL>
    ...
    \begin{frame}[fragile]
        \frametitle{Git, les actions et leurs commandes}
        \framesubtitle{Le local et le remote sont bien différents\footnote{Fetching changes from a remote repository, \url{https://docs.github.com/en/get-started/using-git/getting-changes-from-a-remote-repository\#fetching-changes-from-a-remote-repository}}}
        \transdissolve
...
$ git fetch
    ...
    \begin{frame}[fragile]
        \frametitle{Git, les actions et leurs commandes}
        \framesubtitle{Créer une version à partir des changements locaux\footnote{Fetching changes from a remote repository, \url{https://docs.github.com/en/get-started/using-git/getting-changes-from-a-remote-repository\#fetching-changes-from-a-remote-repository}}}
        \transdissolve
...
Date:   Sun Feb 11 01:18:16 2024 +0100
    ...
    \begin{frame}[fragile]
        \frametitle{Git, les actions et leurs commandes}
        \framesubtitle{Pousser la version locale sur le serveur\footnote{Git Basics - Working with Remotes, \url{https://git-scm.com/book/en/v2/Git-Basics-Working-with-Remotes\#_pushing_remotes}}}
        \transdissolve
...
$ git push origin <nom-de-branche-locale>:<nom-de-branche-distante>
    ...
    \begin{frame}[fragile]
        \frametitle{Git, les actions et leurs commandes}
        \framesubtitle{Tirer les modifications du serveur sur le dépôt local\footnote{Git Basics - Working with Remotes, \url{https://git-scm.com/book/en/v2/Git-Basics-Working-with-Remotes\#_pushing_remotes}}\footnote{Merge, Fast-Forward et rebase: un peu de culture git,\url{https://www.dynamic-mess.com/developpement/git-merge-fast-forward-rebase-culture-git/}}}
        \transdissolve
...
$ git rebase
    ...
    \begin{frame}[fragile]
        \frametitle{Git, les actions et leurs commandes}
        \framesubtitle{Le branching\footnote{Git Branching - Basic Branching and Merging,\url{https://git-scm.com/book/en/v2/Git-Branching-Basic-Branching-and-Merging}}}
        \transdissolve
...
>>>>>>> iss53:index.html
    ...
    \begin{frame}[fragile]
        \frametitle{Git, les actions et leurs commandes}
        \framesubtitle{Patchning avec \lstinline{git rebase}\footnote{Git Commands - Patching, \url{https://git-scm.com/book/en/v2/Appendix-C:-Git-Commands-Patching}}}
        \transdissolve
...
...
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item 2010, le terme \textquote{Continuous Integration} est utilisé pour la première fois dans un livre par Jez Humble.
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Elles s'intègre à de nombreux outils comme les SSO, les outils de gestion de projet et de qualité comme ceux d'Atlassian (Jira, Confluence, Bitbucket, etc).
            ...
            E.g., dans l'embarqué, cela permet de ne pas multiplier le hardware et de limiter le nombre de bancs de test en règle générale la compilation peut prendre beaucoup de ressources CPU et oeut être délocalisée sur un serveur dédié.
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}
        ...
        On confond parfois les deux car le terme DevOps étant plus hype que CI/CD, il plus souvent est utilisé.
        \bigbreak
        \centering
    ...
    \begin{frame}
        ...
        \framesubtitle{Livre et site web de Jez Humble\footnote{Continuous Delivery, \url{https://www.continuousdelivery.com/}}}
        \transdissolve
    ...
    \begin{frame}
        ...
        \framesubtitle{Ce n'est pas une simple technologie mais un marché, attentions aux coûts}
        \transdissolve
        ...
        Contrairement à elles, les plateformes de CI/CD sont souvent payantes.
        \bigbreak
        Parmis les business model, on trouve~:
        \begin{itemize}
            \item Le freemium, une version gratuite limitée en fonctionnalités.
            \begin{itemize}
                \item Github est gratuit jusqu'à une certaine consommation de ressources (temps CPU, disque, etc).
                \item Gradle a toutes ses fonctionnalités en local mais Devlocity, le SAAS qui va avec est payant.
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item AWS CodePipeline permet d'avoir de multiple nodes mais sur des machines AWS uniquement \emoji{money-mouth-face}.
            \item Devlocity n'a qu'une instance centrale du serveur
            \item Leur communauté, une communauté open source peut développer des plugins, des scripts, des outils, etc, pour virtuellement toutes les application qui ne sont pas prévues dans la version de base.
            De ce point de vue, Jenkins est devant les autres.
