...
...
    ...
    \begin{frame}
        ...
        \transdissolve
        Que peut-on faire comme workflow, GitHub Actions, etc, sur le repository de ce cours \url{https://github.com/St-Michel-IT/qualite-code-source/}~?
        \bigbreak
        \centering
...
└── workflows
    ...
    └── shell-check.yml
        \end{lstlisting}
        Un pour généré le document PDF que vous lisez, c'est \lstinline{build-document.yml}, l'autre \lstinline{shell-check.yml} pour vérifier la syntaxe des scripts Shell.
    \end{frame}
