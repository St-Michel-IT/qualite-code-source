...
Out[10]: True
    ...
    \begin{frame}[fragile]
        ...
        Les réels sont exactes si ils peuvent être représentés par une fraction sous la forme~:\[ x / 2^y \]
...
update_the_balance()
    ...
    \begin{frame}[fragile]
        ...
        \begin{itemize}
            ...
            \item Toutes les documentations sont dans les docstring, une structure propre à Python. Les docstrings sont dans l'attribue \lstinline{\_\_doc\_\_} qui peut être appelé dans le shell Python avec la fonction help
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Node JS, dans \lstinline{node\_modules} ou dans le répertoire en fonction de l'installation
